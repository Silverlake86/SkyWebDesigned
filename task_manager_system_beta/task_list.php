<?php
    ...
    $sql = "SELECT * FROM task_list WHERE status = 'PENDING'";
                    ...
                    echo '<div class = "col">';
                        echo '<div class = "table">';
                            ...
                            echo '<ul>';
                                ...
                                echo "<li><h4>Due Date: </h4>". $row["Due_Date"] ."</li>";
                            echo'</ul>';

                            echo"<form action = 'complete.php' method = 'POST'>";
                                echo'<input class = "btn btn1" type = "submit" id = "btn" value = "Complete Task"/>';
                                echo'<input type = "text" class = "cts" name = "container" value ="'. $row["task_id"].'"/>';
                            echo "</form>";
                        echo '</div>';
                    echo '</div>';
                }   
